...
public class GraphicManager {
    ...
    private static final String STYLESHEET = "cssFiles/twoGeneralsGame.css";
    ...
    private Task<Void> sleeperTask() {
        // A method that returns a task that waits X seconds, specified in game.logic game.variables,
