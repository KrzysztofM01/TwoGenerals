...
public class BattleFrontTextBoxGUI extends Pane {
    ...
    public BattleFrontTextBoxGUI(PlayerType playerType, LineType lineType){
        ...
        if (playerType == PlayerType.player){
            this.setLayoutY(VariablesGraphics.battleFieldPositionY + VariablesGraphics.battleFieldHeight);
        } else {
            this.setLayoutY(VariablesGraphics.battleFieldPositionY - VariablesGraphics.battleFrontTextBoxHeight);
        }
